...
path_input <- "03_outputs/simulations/simulated_datasets/polar_bear/with_biologging/"
path_output <- "03_outputs/simulations/model_outputs/polar_bear/"
# path_input <- "data_simulations/polar_bear/"
...
inits <- function() list(beta_phi = runif(n = 3, min = 0.7, max = 1),
                         ...
                         beta_eta = runif(n = 4, min = 0, max = 1),
                         
                         beta_beta = runif(n = 3, min = 0.4, max = 1),
...
params <- c("beta_phi", "s0", "s1", "beta_eta", "beta_beta", "beta_gamma", "p")
