...
path_input <- "03_outputs/simulations/simulated_datasets/main_example/with_biologging/known_offspring_survival/"
# path_output <- "03_outputs/simulations/model_outputs/main_example/with_biologging/known_offspring_survival/"
path_input <- "data_simulations/main_example_offspring_survival/"
path_output <- "res_simulations/main_example_offspring_survival/"
...
inits <- function() list(a1_phi = rnorm(n = 1, mean = 0, sd = 1.5),
                         ...
                         a3_phi = rnorm(n = 1, mean = 0, sd = 3),
                         beta = runif(n = 3, min = 0, max = 1),
                         eta = runif(n = 3, min = 0, max = 1),
...
params <- c("a1_phi", "a2_phi", "a3_phi", "beta", "eta", "gamma", "p") 
...
# load("07_results/model_outputs/CR_GPS_GLS/simulations_revisions/main_example/fit_p_0.25_pGPS_1_pError_0_dataset_47.RData")
# output <- fit_p_0.25_pGPS_1_pError_0_dataset_47[1:2]
# 
# source("05_script/functions_for_models.R")
# params.plot <- c("p", "a1_phi", "a2_phi", "a3_phi", "beta.1.", "beta.2.", "beta.3.", "eta.1.", "eta.2.", "eta.3.", "gamma")
