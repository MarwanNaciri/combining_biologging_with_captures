...
path_input <- "03_outputs/simulations/simulated_datasets/main_example/with_biologging/known_litter_size/"
# path_output <- "03_outputs/simulations/model_outputs/main_example/with_biologging/known_litter_size/"
path_input <- "data_simulations/main_example_litter_size/"
path_output <- "res_simulations/main_example_litter_size/"
