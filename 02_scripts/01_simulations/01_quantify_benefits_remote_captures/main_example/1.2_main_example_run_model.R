...
path_input <- "03_outputs/simulations/simulated_datasets/main_example/with_biologging/baseline/"
# path_output <- "03_outputs/simulations\model_outputs/main_example/baseline"
path_input <- "data_simulations/main_example/"
