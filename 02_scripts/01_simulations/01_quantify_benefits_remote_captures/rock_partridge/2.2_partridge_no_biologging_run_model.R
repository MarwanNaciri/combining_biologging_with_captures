...
path_input <- "03_outputs/simulations/simulated_datasets/rock_partridge/no_biologging/"
path_output <- "03_outputs/simulations/model_outputs/rock_partridge/"
# path_input <- "data_simulations/rock_partridge_no_biologging/"
# path_output <- "res_simulations/rock_partridge/"
...
pause_secs <- sample(seq(from = 10, to = 60, by = 0.25), 1)
Sys.sleep(pause_secs)

# Retrieve input file names
file_list <- list.files(path_input)
# file_list <- file_list[-grep(pattern = "pGPS_0_", x = file_list)]
